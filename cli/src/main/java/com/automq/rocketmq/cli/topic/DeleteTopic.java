...
@CommandLine.Command(name = "deleteTopic", mixinStandardHelpOptions = true, showDefaultValues = true)
public class DeleteTopic implements Callable<Void> {

    @CommandLine.Option(names = {"-i", "--id"}, description = "Topic ID", required = true)
    long id;
