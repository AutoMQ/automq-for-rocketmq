...
public class S3ObjectMetricsStats {
    ...
    public static final Counter s3ObjectCount = S3StreamMetricsRegistry.METRICS_GROUP.newCounter(S3MetricsType.S3Object.getName(),
            S3MetricsType.S3Object.getName() + "Count", Collections.emptyMap());
    public static final Histogram s3ObjectSize = S3StreamMetricsRegistry.METRICS_GROUP.newHistogram(S3MetricsType.S3Object.getName(),
    ...
    public static Histogram getOrCreateS3ObjectMetrics(S3ObjectStage stage) {
        return S3_OBJECT_TIME_MAP.computeIfAbsent(stage.getName(), op -> {
            ...
            return S3StreamMetricsRegistry.METRICS_GROUP.newHistogram(S3MetricsType.S3Object.getName(),
