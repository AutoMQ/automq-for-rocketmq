...
//            consumerGroupId, topicId, queueId, offset, batchSize, invisibleDuration, operationTimestamp, operationType
//        );
//        // return topicQueue.pop(consumerGroupId, filter, batchSize, fifo, retry, invisibleDuration);
//        CompletableFuture<Long> logOperationFuture = operationLogService.logPopOperation(popOperation);
//
//        long streamId;
//        if (retry) {
